...
public class TeamScheduleModal {
    ...
    public TeamScheduleModal(String team1_name, String team1_short_name, String team2_name, String team2_short_name, String matchDay, int matchTime, boolean isTeamAvailable) {
